...
const EducationListItem = (props) => {
  ...
  const { degree, end_date, location_school , school_name , start_date  } = props.data;
  return (
    <li className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-4"><EducationItem title={column[4]} descriptions={start_date}/> - <EducationItem title={column[5]} descriptions={end_date}/></div>
    </li>
  );
};
